#
# Be sure to run `pod lib lint ZWViewUtils.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ZWViewUtils'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZWViewUtils.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'ZWViewUtils/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ZWViewUtils' => ['ZWViewUtils/Assets/*.png']
  # }
